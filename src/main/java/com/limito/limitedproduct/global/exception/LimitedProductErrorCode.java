...
public enum LimitedProductErrorCode implements ErrorCode {
	...
	PRODUCT_WRONG_CATEGORY_ID(HttpStatus.BAD_REQUEST, "상품 카테고리가 올바르지 않습니다. 이미 등록된 상품입니다."),
	PRODUCT_WRONG_BRAND_NAME(HttpStatus.BAD_REQUEST, "브랜드명이 올바르지 않습니다. 이미 등록된 상품입니다.");
